...
This is model #0, captured at step 40k (max: 2000k, i.e., 2M steps).
...
model = TFBertModel.from_pretrained("google/multiberts-seed_0-step_40k")
...
tokenizer = BertTokenizer.from_pretrained('google/multiberts-seed_0-step_40k')
model = BertModel.from_pretrained("google/multiberts-seed_0-step_40k")
text = "Replace me by any text you'd like."
