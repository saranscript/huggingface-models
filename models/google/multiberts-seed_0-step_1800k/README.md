...
This is model #0, captured at step 1800k (max: 2000k, i.e., 2M steps).
...
tokenizer = BertTokenizer.from_pretrained('google/multiberts-seed_0-step_1800k')
model = TFBertModel.from_pretrained("google/multiberts-seed_0-step_1800k")
...
tokenizer = BertTokenizer.from_pretrained('google/multiberts-seed_0-step_1800k')
model = BertModel.from_pretrained("google/multiberts-seed_0-step_1800k")
text = "Replace me by any text you'd like."
