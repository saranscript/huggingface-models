...
This is model #0, captured at step 60k (max: 2000k, i.e., 2M steps).
...
tokenizer = BertTokenizer.from_pretrained('google/multiberts-seed_0-step_60k')
model = TFBertModel.from_pretrained("google/multiberts-seed_0-step_60k")
