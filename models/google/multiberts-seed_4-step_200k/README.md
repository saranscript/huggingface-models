...
This is model #4, captured at step 200k (max: 2000k, i.e., 2M steps).
...
tokenizer = BertTokenizer.from_pretrained('google/multiberts-seed_4-step_200k')
model = TFBertModel.from_pretrained("google/multiberts-seed_4-step_200k")
...
tokenizer = BertTokenizer.from_pretrained('google/multiberts-seed_4-step_200k')
model = BertModel.from_pretrained("google/multiberts-seed_4-step_200k")
text = "Replace me by any text you'd like."
