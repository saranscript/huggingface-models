...
This is model #3, captured at step 500k (max: 2000k, i.e., 2M steps).
...
tokenizer = BertTokenizer.from_pretrained('google/multiberts-seed_3-step_500k')
model = TFBertModel.from_pretrained("google/multiberts-seed_3-step_500k")
...
tokenizer = BertTokenizer.from_pretrained('google/multiberts-seed_3-step_500k')
model = BertModel.from_pretrained("google/multiberts-seed_3-step_500k")
text = "Replace me by any text you'd like."
