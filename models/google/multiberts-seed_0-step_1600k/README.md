...
This is model #0, captured at step 1600k (max: 2000k, i.e., 2M steps).
...
tokenizer = BertTokenizer.from_pretrained('google/multiberts-seed_0-step_1600k')
model = TFBertModel.from_pretrained("google/multiberts-seed_0-step_1600k")
...
tokenizer = BertTokenizer.from_pretrained('google/multiberts-seed_0-step_1600k')
model = BertModel.from_pretrained("google/multiberts-seed_0-step_1600k")
text = "Replace me by any text you'd like."
