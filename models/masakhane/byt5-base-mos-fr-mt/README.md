...
# byt5-base-mos-fr-mt
## Model description
**byt5-base-mos-fr-mt** is a **machine translation** model from Mossi to French based on a fine-tuned google/byt5-base model.  It establishes a **strong baseline** for automatically translating texts from Mossi to French.  
...
Fine-tuning byt5-base achieves **5.34 BLEU** on [LAFAND test set](https://github.com/masakhane-io/lafand-mt)
