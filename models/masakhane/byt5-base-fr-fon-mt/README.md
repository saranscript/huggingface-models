...
# byt5-base-fr-fon-mt
## Model description
**byt5-base-fr-fon-mt** is a **machine translation** model from French to Fon based on a fine-tuned google/byt5-base model.  It establishes a **strong baseline** for automatically translating texts from French to Fon.  
...
Fine-tuning byt5-base achieves **2.63 BLEU** on [LAFAND test set](https://github.com/masakhane-io/lafand-mt)
