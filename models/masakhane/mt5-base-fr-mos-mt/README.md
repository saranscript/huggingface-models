...
# mt5-base-fr-mos-mt
## Model description
**mt5-base-fr-mos-mt** is a **machine translation** model from French to Mossi based on a fine-tuned google/mt5-base model.  It establishes a **baseline** for automatically translating texts from French to Mossi.  
...
Fine-tuning mt5-base achieves **1.96 BLEU** on [LAFAND test set](https://github.com/masakhane-io/lafand-mt)
