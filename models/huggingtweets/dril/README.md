---
language: en
thumbnail: http://www.huggingtweets.com/dril/1639048500090/predictions.png
tags:
- huggingtweets
widget:
- text: "My dream is"
...
[Explore the data](https://wandb.ai/wandb/huggingtweets/runs/2sdsp2xz/artifacts), which is tracked with [W&B artifacts](https://docs.wandb.com/artifacts) at every step of the pipeline.

## Training procedure

The model is based on a pre-trained [GPT-2](https://huggingface.co/gpt2) which is fine-tuned on @dril's tweets.

Hyperparameters and metrics are recorded in the [W&B training run](https://wandb.ai/wandb/huggingtweets/runs/btq6261n) for full transparency and reproducibility.

At the end of training, [the final model](https://wandb.ai/wandb/huggingtweets/runs/btq6261n/artifacts) is logged and versioned.
