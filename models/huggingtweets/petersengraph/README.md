...
<div class="inline-flex flex-col" style="line-height: 1.5;">
    <div class="flex">
        <div
			style="display:inherit; margin-left: 4px; margin-right: 4px; width: 92px; height:92px; border-radius: 50%; background-size: cover; background-image: url(&#39;https://pbs.twimg.com/profile_images/1061943337769361409/FHWcl8dY_400x400.jpg&#39;)">
        </div>
        <div
    ...
    <div style="text-align: center; font-size: 16px; font-weight: 800">The Petersen Graph</div>
    <div style="text-align: center; font-size: 14px;">@petersengraph</div>
</div>
...
The model was trained on tweets from The Petersen Graph.
...
generator = pipeline('text-generation',
                     model='huggingtweets/petersengraph')
