---
language: en
thumbnail: https://www.huggingtweets.com/shamscharania/1632748430882/predictions.png
tags:
- huggingtweets
widget:
- text: "My dream is"
...
[Explore the data](https://wandb.ai/wandb/huggingtweets/runs/56bd7er5/artifacts), which is tracked with [W&B artifacts](https://docs.wandb.com/artifacts) at every step of the pipeline.

## Training procedure

The model is based on a pre-trained [GPT-2](https://huggingface.co/gpt2) which is fine-tuned on @shamscharania's tweets.

Hyperparameters and metrics are recorded in the [W&B training run](https://wandb.ai/wandb/huggingtweets/runs/2bjbr2qh) for full transparency and reproducibility.

At the end of training, [the final model](https://wandb.ai/wandb/huggingtweets/runs/2bjbr2qh/artifacts) is logged and versioned.
