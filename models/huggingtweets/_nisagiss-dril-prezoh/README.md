...
<div class="inline-flex flex-col" style="line-height: 1.5;">
    ...
    <div style="text-align: center; font-size: 16px; font-weight: 800">Nisa 🇲🇽 & wint & prezoh</div>
...
The model was trained on tweets from Nisa 🇲🇽 & wint & prezoh.

| Data | Nisa 🇲🇽 | wint | prezoh |
| --- | --- | --- | --- |
